...
import { View, Text, Alert, Image, Linking, BackHandler } from 'react-native';
...
class Menu extends Component {
                ...
                <View style={{ height: 440 }}>
                    ...
                    <View style={{ alignItems: 'center' }}>
                        ...
                        <MenuItem 
                            ...
                            itemPress={() => navigation.navigate("FullWebview", 'https://wwfoldschool.com/privacy-policy/')}
                        />
    ...
    renderHeader = () => {
        return(
            <View style={{ backgroundColor: isOpen ? '#212121' : 'black', borderTopLeftRadius: 16, borderTopRightRadius: 16, 
